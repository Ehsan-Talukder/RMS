...
<div class="row ">
  ...
  ?>
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <a href="category_food.php?name=<?php echo $name ?>&&subcategory=<?php echo $subcategory ?>">
          <div class="card">
          ...
          <div class="tab_content current active pt-45">
            ...
            <div class="tabs_item current">
              <div class="row justify-content-center">
                ...
                $sql = "SELECT * FROM food_item  where ((category_name='$name')&&(subcategory='$subcategory')) ORDER BY id ASC";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                  // output data of each row
                  while ($row = $result->fetch_assoc()) {
                      ...
                      <div class="featured-item">
                        ...
                        <div class="content">
                          ...
                          <div class="content-in">
                            <h4 value="price" name="price"><?php echo $row['price'] ?></h4>
                          ...
                          <div class="featured-content-list">
                            ...
                            <a href="order_store.php?id=<?php echo $row['id']?>" class="fault-btn border-radius-5"> Add to cart</a>
                          </div>
                        </div>
                      </div>
                    </div>
